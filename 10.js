...
function task10() {
  ...
  Promise.any([promise1, promise2, promise3])
    .then((value) => {
      console.log("Перший вирішений проміс:", value);
    })
    .catch((error) => {
      console.error("Усі проміси відхилені:", error);
    });
  // Створюємо проміс promise1, які вирішуються через 500мс, та повертають як успішне виконання рядок .
